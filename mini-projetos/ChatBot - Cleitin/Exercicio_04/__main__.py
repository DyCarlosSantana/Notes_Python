    ...
    try:
        ...
        resposta = cliente.chat.completions.create(
            messages=[
                {
                    "role": "system",
                    "content": f"Você ajuda no processo de arquivos e dados. Analise o ficheito anexado, e retorne uma estrutura formato em JSON, sendo sempre bem direto e objetivo."},
                {
                    "role": "user",
        ...
        painel_resposta = Panel(resposta_chat, title="Cleitin (ChatBot):", subtitle="Digite 'sair' para encerrar a sessão", border_style="green", width=80)
